...
static __Pyx_memviewslice __pyx_f_4test_calc_acc(float, __Pyx_memviewslice, __Pyx_memviewslice, float); /*proto*/
...
static PyObject *__pyx_pf_4test_simulate(CYTHON_UNUSED PyObject *__pyx_self, float __pyx_v_G, int __pyx_v_N, float __pyx_v_dt, float __pyx_v_t, float __pyx_v_t_max, float __pyx_v_soft_param); /* proto */
...
static __Pyx_memviewslice __pyx_f_4test_calc_acc(float __pyx_v_G, __Pyx_memviewslice __pyx_v_pos, __Pyx_memviewslice __pyx_v_mass, float __pyx_v_soft_param) {
 ...
 */
  ...
  __Pyx_AddTraceback("test.calc_acc", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_4test_1simulate(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_4test_1simulate = {"simulate", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4test_1simulate, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_4test_1simulate(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  float __pyx_v_G;
  int __pyx_v_N;
  float __pyx_v_dt;
  float __pyx_v_t;
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("test.simulate", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4test_simulate(__pyx_self, __pyx_v_G, __pyx_v_N, __pyx_v_dt, __pyx_v_t, __pyx_v_t_max, __pyx_v_soft_param);
...
static PyObject *__pyx_pf_4test_simulate(CYTHON_UNUSED PyObject *__pyx_self, float __pyx_v_G, int __pyx_v_N, float __pyx_v_dt, float __pyx_v_t, float __pyx_v_t_max, float __pyx_v_soft_param) {
 ...
 */
  __pyx_t_8 = __pyx_f_4test_calc_acc(__pyx_v_G, __pyx_v_pos, __pyx_v_mass, __pyx_v_soft_param); if (unlikely(!__pyx_t_8.memview)) __PYX_ERR(0, 63, __pyx_L1_error)
 ...
 *       # second kick
 */
    __pyx_t_8 = __pyx_f_4test_calc_acc(__pyx_v_G, __pyx_v_pos, __pyx_v_mass, __pyx_v_soft_param); if (unlikely(!__pyx_t_8.memview)) __PYX_ERR(0, 76, __pyx_L1_error)
 ...
 *   cdef double[:,:] pos  = np.random.randn(N,3).astype(np.double) # normally distributed positions
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4test_1simulate, NULL, __pyx_n_s_test); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 41, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
